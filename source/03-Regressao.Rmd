...
[^5]: Se você leu a discussão anterior de tipos de objetos, vale observar que reg é uma lista

[^6]:Nada haver com carro: é uma sigla para Companion to Applied Reggresion

[^7]:Nem sempre o R vai ignorar um NA. Isso depende do pacote e das configurações do R